...
import './sec8.css'
import img1 from "./image/Frame 48.png"
const Sec8 = () => {
    return (
        <section className="sec8">
            <div className="sec8-box1">
                ...
                <div className="sec8-right1">
                    ...
                    <div className="sec8-bottom flex pt-5">
                        <button className="btn2 mb-4 pt-2 pr-3">
                            <label className="block text-gray-700"></label>
                            <input
                                type="text"
                                name="name"
                                className=" bg-[#F0F2F5] border-[#5C8EE5] border-[2px] w-[300px] h-[56px] pl-[20px]"
                                placeholder="Имя"
                                required/>
                        </button>
                        <button className="btn3 mb-4 mt-1">
                            <label className="block text-[#828A99] text-[10px] absolute ml-5">Номер телефона</label>
                            <input
                                type="tel"
                                name="phone"
                                className="pt-2 bg-[#F0F2F5] placeholder-[#292D33] border-[#5C8EE5] border w-[300px] h-[56px] pl-[20px]"
                    ...
                    <div className="bottom1">
                        ...
                        <p className="p-mobile flex text-[14px] text-[#828A99] ml-5 mt-7">
